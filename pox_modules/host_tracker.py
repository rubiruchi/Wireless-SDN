...
log = core.getLogger()
try:
    os.remove('host_tracker.txt')
except OSError:
    pass
the_file = open('host_tracker.txt', 'a')
...
class host_tracker (EventMixin):
  ...
  def _handle_openflow_ConnectionUp (self, event):
    ...
    the_file.write("Time: " + time.asctime(time.localtime(time.time())) + "\n")
    the_file.write("In connection up\n")
    the_file.write("destination mac: " + str(self.ping_src_mac) + "\n")
  ...
  def _handle_openflow_PacketIn (self, event):
    ...
    the_file.write("Time: " + time.asctime(time.localtime(time.time())) + "\n")
    the_file.write("In PacketIn: \n")
    if(str(packet.src)=="02:00:00:00:be:ef" or str(packet.src)=="00:00:00:00:00:22" or str(packet.src)=="00:00:00:00:00:11"):
      the_file.write("DPID: " + dpid_to_str(dpid) +" src mac: " + str(packet.src) + " dst mac: " + str(packet.dst) + "\n")
